...
module.exports = {
	...
	'rules': {
		 ...
		 * @report    Warning
		 */
		'@webdevstudios/eslint-plugin/@author': 1,
		 ...
		 * @report    Error
		 */
		'@webdevstudios/eslint-plugin/@since': 2,
		 ...
		 * @report    Error
		 */
		'@webdevstudios/eslint-plugin/functionExpressionRequireDocblock': 2,
